# Generated by Powerlevel10k configuration wizard on 2024-03-12 at 23:37 CET.
...
# vertical separators, sharp heads, flat tails, 2 lines, dotted, no frame, compact,
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=01
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local   modified='%03F'  # yellow foreground
      local  untracked='%06F'   # blue foreground
